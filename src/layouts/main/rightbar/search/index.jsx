...
//             viewBox="0 0 24 24"
//             height={18.75}
//             className="h-4 min-w-[32px] text-[color:var(--color-base-secondary)] group-focus-within:text-[color:var(--color-primary)] "
//           >
//             <path
//               fill="currentColor"
...
//       </label>
//       {focus && (
//         <div className="absolute w-[350px] top-full -translate-y-1 -left-px   shadow-box max-h-[calc(80vh-53px)] rounded-lg text-center min-h-[100px] ">
//           <p className="p-3 pt-5  [color:var(--color-base-secondary)] leading-5">Try searching for people, lists or keywords</p>
//         </div>
//       )}
//     </div>
//   );
...
export default function Search() {
  ...
  return (
    <div ref={ref} className="min-h-[32px] h-[3.313rem] mb-3 flex items-center sticky top-0 bg-[color:var(--background-primary)] z-10">
      <label className="h-[43px] rounded-full bg-[color:var(--background-third)] w-full relative group border border-transparent focus-within:bg-[color:var(--background-primary)] focus-within:border-[color:var(--color-primary)]">
        <div className="w-[56px] h-full flex items-center justify-center absolute top-0 left-0 pointer-events-none">
          <svg
            viewBox="0 0 24 24"
            className="h-[18.75px] min-w-[32px] text-[color:var(--color-base-secondary)] group-focus-within:text-[color:var(--color-primary)]"
          >
            <path
              fill="currentColor"
              d="M10.25 3.75c-3.59 0-6.5 2.91-6.5 6.5s2.91 6.5 6.5 6.5c1.795 0 3.419-.726 4.596-1.904 1.178-1.177 1.904-2.801 1.904-4.596 0-3.59-2.91-6.5-6.5-6.5zm-8.5 6.5c0-4.694 3.806-8.5 8.5-8.5s8.5 3.806 8.5 8.5c0 1.986-.682 3.815-1.824 5.262l4.781 4.781-1.414 1.414-4.781-4.781c-1.447 1.142-3.276 1.824-5.262 1.824-4.694 0-8.5-3.806-8.5-8.5z"
        ...
        <input
          type="text"
          placeholder="Search"
          className="w-full h-full bg-transparent rounded-full outline-none pl-[56px]"
          value={query}
          onFocus={() => setFocus(true)}
          onChange={(e) => setQuery(e.target.value)}
        />
      ...
      {focus && (
        <div className="absolute w-[350px] top-full -left-px -translate-y-1 bg-[color:var(--background-primary)] shadow-box max-h-[calc(80vh-53px)] rounded-lg text-center min-h-[100px]">
          <p className="p-3 pt-5 text-[color:var(--color-base-secondary)] leading-5">Try searching for people, lists or keywords </p>
        </div>
      )}
    </div>
  );
