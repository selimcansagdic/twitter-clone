import { Disclosure, DisclosureButton, DisclosurePanel, Popover, PopoverPanel, PopoverButton } from "@headlessui/react";
    ...
    <Popover className="relative ">
      ...
      <PopoverPanel className="w-[318px] absolute bottom-0 left-0 bg-[color:var(--background-primary)] shadow-box rounded-xl overflow-hidden ">
        ...
        <button className="px-4 h-14 w-full  transition-colors inline-flex items-center gap-5 hover:bg-[color:var(--background-secondary)]">
          <div className="w-[26.25px] h-[26.25px] relative">
            <svg viewBox="0 0 24 24" width={24} height={24}>
              <path
                fill="currentColor"
                d="M23 3v14h-2V5H5V3h18zM10 17c1.1 0 2-1.34 2-3s-.9-3-2-3-2 1.34-2 3 .9 3 2 3zM1 7h18v14H1V7zm16 10c-1.1 0-2 .9-2 2h2v-2zm-2-8c0
        1.1.9 2 2 2V9h-2zM3 11c1.1 0 2-.9 2-2H3v2zm0 4c2.21 0 4 1.79 4 4h6c0-2.21 1.79-4 4-4v-2c-2.21 0-4-1.79-4-4H7c0 2.21-1.79 4-4 4v2zm0
        ...
        <Disclosure>
          {({ open }) => (
            <>
              <DisclosureButton className="h-[52px] flex items-center justify-between w-full px-4 font-bold hover:bg-[color:var(--background-secondary)] transition-colors">
              ...
              <DisclosurePanel>
                <Link to="/" className="flex items-center px-3 h-11 gap-3 font-medium hover:bg-[color:var(--background-secondary)] transition-colors">
