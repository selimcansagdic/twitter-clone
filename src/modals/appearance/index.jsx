...
export default function AppearanceModal({ close }) {
  ...
  return (
    <div about="Appearance Modal" className="w-[600px]">
      <h3 className="mt-8 mb-3 text-[23px] leading-7 font-extrabold text-center">Appearance</h3>
      <div className="p-8 pt-0">
        <p className="text-center [color:var(--color-base-secondary)] leading-5 text-[15px] mb-5">
          ...
          <div className="border border-[color:var(--background-third)] px-4 flex py-3 gap-3 rounded-2xl">
            ...
            <div className="flex-1 flex flex-col">
              <header className="mb-0.5 leading-5 text-[15px] flex items-center">
                ...
                <div className="ml-1 flex items-center  [color:var(--color-base-secondary)]">@X · 2h</div>
              </header>
              <div className="text-[color:var(--color-base)] leading-5 text-[15px]">
                At the heart of X are short messages called posts — just like this one — which can include photos, videos, links, text,
          ...
          <div className="py-2 px-4 mb-3 grid gap-2 grid-cols-3 bg-[color:var(--background-secondary)] rounded-2xl ">
            <button
              ...
              className={classNames(
                "h-16 pr-3 pl-2 bg-white text-[#0f1419] border border-white/10  font-bold rounded group flex items-center gap-1.5",
                {
            ...
            <button
              ...
              className={classNames(
                "h-16 pr-3 pl-2 bg-[#15202b] text-[#f7f9f9] border border-white/10 font-bold rounded group flex items-center gap-1.5",
                {
            ...
            <button
              ...
              className={classNames(
                "h-16 pr-3 pl-2 bg-black text-[#f7f9f9] border border-white/10 font-bold rounded group flex items-center gap-1.5",
                {
